...
const translations = {
  en: {
    ...
    'dashboard.revenueGenerated': 'Total Revenue',
    ...
    'dashboard.section.overall': 'Overall Business',
    'dashboard.section.stockHealth': 'Stock Health',
    'dashboard.section.topSellers': 'Best Sellers (Last 30 Days)',
    'dashboard.section.byCategory': 'Stock by Category',
    'dashboard.section.storage': 'Storage Used',
    'dashboard.revenueToday': 'Revenue Today',
    'dashboard.profitToday': 'Profit Today (est.)',
    'dashboard.profitGenerated': 'Total Profit (est.)',
    'dashboard.profitHint':
      "This is an estimate: your selling price minus the acquired (cost) price for everything sold, using each item's current acquired price.",
    'dashboard.inStock': 'In Stock',
    'dashboard.lowStock': 'Running Low (≤{n})',
    'dashboard.outOfStock': 'Out of Stock',
    'dashboard.noSales': 'No sales yet in the last 30 days.',
    'dashboard.noCategories': 'No products yet.',
    'dashboard.productsCount': '{n} products',
    'dashboard.unitsSold': '{n} sold',
  ...
  te: {
    ...
    'dashboard.revenueGenerated': 'మొత్తం ఆదాయం',
    ...
    'dashboard.section.today': 'ఈరోజు',
    'dashboard.section.overall': 'మొత్తం వ్యాపారం',
    'dashboard.section.stockHealth': 'స్టాక్ స్థితి',
    'dashboard.section.topSellers': 'బాగా అమ్ముడైనవి (గత 30 రోజులు)',
    'dashboard.section.byCategory': 'వర్గం వారీగా స్టాక్',
    'dashboard.section.storage': 'వాడిన నిల్వ',
    'dashboard.revenueToday': 'ఈరోజు ఆదాయం',
    'dashboard.profitToday': 'ఈరోజు లాభం (అంచనా)',
    'dashboard.profitGenerated': 'మొత్తం లాభం (అంచనా)',
    'dashboard.profitHint':
      'ఇది ఒక అంచనా: అమ్మిన ప్రతిదానికి అమ్మకం ధర నుండి కొనుగోలు ధరను తీసివేయగా వచ్చేది, ప్రతి వస్తువు యొక్క ప్రస్తుత కొనుగోలు ధర ఆధారంగా.',
    'dashboard.inStock': 'స్టాక్‌లో ఉంది',
    'dashboard.lowStock': 'తక్కువగా ఉంది (≤{n})',
    'dashboard.outOfStock': 'స్టాక్ లేదు',
    'dashboard.noSales': 'గత 30 రోజుల్లో అమ్మకాలు లేవు.',
    'dashboard.noCategories': 'ఇంకా ఉత్పత్తులు లేవు.',
    'dashboard.productsCount': '{n} ఉత్పత్తులు',
    'dashboard.unitsSold': '{n} అమ్ముడయ్యాయి',
