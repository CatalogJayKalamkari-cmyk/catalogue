...
export const ui: UiDict = {
  ...
  'catalog.unavailable.title': 'తాత్కాలికంగా అందుబాటులో లేదు',
  'catalog.unavailable.body': 'మేము మెయింటెనెన్స్ చేస్తున్నాము. దయచేసి కొద్దిసేపటిలో మళ్ళీ చూడండి.',
